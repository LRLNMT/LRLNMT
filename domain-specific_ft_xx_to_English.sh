...
function train () {
    ...
    printf "******************** Start training on: $3-$2-domain for ${lang_tag} to en_XX direction ********************\n"
    ...
    model_save_path_xx_to_en="$2_$3_${lang_tag}-en_model"
    ...
    printf "******************** Finished training on: $3-$2-domain for ${lang_tag} to en_XX direction ********************\n"
    
    printf "******************** Testing with other domain-speific test sets on: $model_save_path_xx_to_en ********************\n"
    ...
    do
        ...
        printf "******************** Start TESTING for: ${test_path_array[3]}-domain on: $model_save_path_xx_to_en ********************\n"
        ...
        model_test_save_path_xx_to_en="$2_$3_${lang_tag}-en_model_test_on_${test_path_array[3]}"
        ...
        printf "******************** Finished TESTING for: ${test_path_array[3]}-domain on: $model_save_path_xx_to_en ********************\n"
    done
    
    printf "******************** END of $3-$2-domain for ${lang_tag} to en_XX direction ********************\n"
